...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.title.setText(_translate("MainWindow", "DrawBot Mono tarafından"))
        self.urlTextBox.setPlaceholderText(_translate("MainWindow", "Tasarım görselinin URL'si"))
        self.appLabel.setText(_translate("MainWindow", "Ne kadar tasarladınız?"))
        ...
        self.speedLabel.setText(_translate("MainWindow", "Hız"))
        self.skippedPixelsLabel.setText(_translate("MainWindow", "Pikseller göz ardı edildi"))
        self.label_4.setText(_translate("MainWindow", "Ne kadar az görmezden gelirsek, o kadar kesin (ama yavaş) olur"))
        self.ignorePixelBox.setText(_translate("MainWindow", "Tek pikselleri yoksay"))
        self.ditherBox.setText(_translate("MainWindow", "Titreşim"))
        self.coordinateButton.setText(_translate("MainWindow", "Fare koordinatlarını alın (sonraki tıklamada)"))
        self.MouseCoordinateLabel.setText(_translate("MainWindow", "İletişim bilgileri burada görünecek"))
        self.setBoundsButton.setText(_translate("MainWindow", "Çizim boyutunu ayarla"))
        self.widthLabel.setText(_translate("MainWindow", "Şu anda: Yok."))
        self.drawButton.setText(_translate("MainWindow", "Çizmek!"))
    ...
    def setPixelInterval(self, value):
        ...
        self.skippedPixelsLabel.setText("Pikseller göz ardı edildi: " + str(value))
    ...
    def setBoundsWorker(self):
        self.widthLabel.setText("Şu anda seçiliyor...")
    ...
    def draw(self):
        if self.url != "" and self.width != 0:
            ...
            if self.url == "":
                self.errorLabel.setText("Bir URL'ye ihtiyacım var")
            elif self.width == 0:
                self.errorLabel.setText("İstenilen çizim boyutuna ihtiyacım var")
    ...
    def drawWorker(self):
        try:
            ...
            print(error)
            self.errorLabel.setText("URL kötü veya resim değil")
            pass
        self.drawingThread = None
